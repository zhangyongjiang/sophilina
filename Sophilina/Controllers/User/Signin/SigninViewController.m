...
@property(strong, nonatomic)SigninPage* page;
...
//    self.title = @"Sign In";
    ...
    self.page = [[SigninPage alloc] initWithFrame:self.view.bounds];
    self.page.y = y;
...
- (void)forgotPasswordClicked {
    [self.navigationController pushViewController:[[RecoverPasswordViewController alloc] init] animated:YES];
}
